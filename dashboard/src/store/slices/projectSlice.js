...
export const getAllProjects = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://portfolio-backend-actq.onrender.com/api/v1/projrct/getall",
...
export const addNewProject = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://portfolio-backend-actq.onrender.com/api/v1/projrct/add",
      data,
      {
        withCredentials: true,
...
export const deleteProject = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://portfolio-backend-actq.onrender.com/api/v1/projrct/delete/${id}`,
      {
        withCredentials: true,
      }
    );
...
export const updateProject = (id, newData) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://portfolio-backend-actq.onrender.com/api/v1/projrct/update/${id}`,
      newData,
      {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
